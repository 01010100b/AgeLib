...
{
    C_LESS_THAN, C_LESS_OR_EQUAL, C_GREATER_THAN, C_GREATER_OR_EQUAL, C_EQUAL, C_NOT_EQUAL,
    G_LESS_THAN = 7, G_LESS_OR_EQUAL, G_GREATER_THAN, G_GREATER_OR_EQUAL, G_EQUAL, G_NOT_EQUAL,
    S_LESS_THAN = 14, S_LESS_OR_EQUAL, S_GREATER_THAN, S_GREATER_OR_EQUAL, S_EQUAL, S_NOT_EQUAL
}

public enum MathOp
{
    C_SET, C_ADD, C_SUB, C_MUL, C_DIV, C_DIV_ROUND, C_MOD, C_MIN, C_MAX, C_NEG, C_PERC_DIV, C_PERC_MUL,
    G_SET, G_ADD, G_SUB, G_MUL, G_DIV, G_DIV_ROUND, G_MOD, G_MIN, G_MAX, G_NEG, G_PERC_DIV, G_PERC_MUL,
    S_SET, S_ADD, S_SUB, S_MUL, S_DIV, S_DIV_ROUND, S_MOD, S_MIN, S_MAX, S_NEG, S_PERC_DIV, S_PERC_MUL
}

public enum FactId
{
    GAME_TIME, POPULATION_CAP, POPULATION_HEADROOM, HOUSING_HEADROOM, IDLE_FARM_COUNT, FOOD_AMOUNT, 
    WOOD_AMOUNT, STONE_AMOUNT, GOLD_AMOUNT, ESCROW_AMOUNT, COMMODITY_BUYING_PRICE, 
    COMMODITY_SELLING_PRICE, DROPSITE_MIN_DISTANCE, SOLDIER_COUNT, ATTACK_SOLDIER_COUNT, 
    DEFEND_SOLDIER_COUNT, WARBOAT_COUNT, ATTACK_WARBOAT_COUNT, DEFEND_WARBOAT_COUNT, CURRENT_AGE, 
    CURRENT_SCORE, CIVILIZATION, PLAYER_NUMBER, PLAYER_IN_GAME, UNIT_COUNT, UNIT_TYPE_COUNT, 
    UNIT_TYPE_COUNT_TOTAL, BUILDING_COUNT, BUILDING_TYPE_COUNT, BUILDING_TYPE_COUNT_TOTAL,
    POPULATION, MILITARY_POPULATION, CIVILIAN_POPULATION, RANDOM_NUMBER, RESOURCE_AMOUNT, 
    PLAYER_DISTANCE, ALLIED_GOAL, ALLIED_SN, RESOURCE_PERCENT, ENEMY_BUILDINGS_IN_TOWN, ENEMY_UNITS_IN_TOWN, 
    ENEMY_VILLAGERS_IN_TOWN, PLAYERS_IN_GAME, DEFENDER_COUNT, BUILDING_TYPE_IN_TOWN, 
    UNIT_TYPE_IN_TOWN, VILLAGER_TYPE_IN_TOWN, GAIA_TYPE_COUNT, GAIA_TYPE_COUNT_TOTAL,
    CC_GAIA_TYPE_COUNT, CURRENT_AGE_TIME, TIMER_STATUS, PLAYERS_TRIBUTE, PLAYERS_TRIBUTE_MEMORY, TREATY_TIME
}
...
public enum CmdId
{
    FLAG, LIVESTOCK_GAIA, CIVILIAN_BUILDING, VILLAGER, MILITARY, TRADE, MONK, TRANSPORT, RELIC, 
    FISHING_SHIP, MILITARY_BUILDING
}
...
{
    DEFAULT, MOVE, PATROL, GUARD, FOLLOW, STOP, GROUND, GARRISON, DELETE, UNLOAD, TRAIN, 
    GATHER, LOCK, WORK, UNGARRISON, DROP_RELIC, PACK, UNPACK, NONE
}
...
{
    CENTER, OPPOSITE, CORNER, ENEMY, BORDER, MIRROR, FLANK, ZERO, MAP_SIZE, SELF, 
    TARGET, FOCUS, OBJECT, POINT
}
